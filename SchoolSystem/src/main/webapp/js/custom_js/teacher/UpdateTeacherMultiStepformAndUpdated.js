...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      $("#first_name").keyup(function()
      {
            ...
            else if( $("#first_name").val().length <= 2)
            {
                  ...
                  $("#first_name").focus();
                  $("#next-1").prop("disabled",true);
                  $("#fname_error").html("Plaese Input First Name Then 2 Charictor ..... !!!") ;
                  $("#fname_error").css("font-size","16");
                  $("#fname_error").css("font-weight","bold");
                  return isfname= false;
            }
            else if($("#first_name").val().match( /^[A-Za-z]+$/ ) )
            {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      $("#last_name").keyup(function(){
            ...
            if($("#last_name").val().length <= 2)
            {
                  ...
                  $("#last_name").focus();
                  $("#next-1").prop("disabled",true);
                  $("#lname_error").html("Plaese Input Last Name Then 2 Charictor ..... !!!") ;
                  $("#lname_error").css("font-size","16");
                  $("#lname_error").css("font-weight","bold");
                  return islname= false;
            }
...
$("#nationality_id").keyup(function()
{
     ...
     if( $("#nationality_id").val().match(/^\d{9}$/) )
      {
...
{
      if( $("#passport_no").val().length == 0 || $("#passport_no").val() == null )
       {
            $("#passport_no").css("border-color", "red");
            $("#passport_no").css("background-color","pink");
            $("#passport_no").focus();
            $("#passport_no_error").html("Plaese Input Passport Number  ..... !!!")  ;
            $("#passport_no_error").css("font-size","16");
            $("#passport_no_error").css("font-weight","bold");
            $("#next-4").prop("disabled",true);
		return ispassport = false;
      }
      else if(( $("#passport_no").val().length < 9))
      {
            $("#passport_no").css("border-color", "red");
            $("#passport_no").css("background-color","pink");
            $("#passport_no").focus();
            $("#passport_no_error").html("Plaese Input Passport Number 9  ..... !!!")  ;
            $("#passport_no_error").css("font-size","16");
            $("#passport_no_error").css("font-weight","bold");
            $("#next-4").prop("disabled",true);
		return ispassport = false;
      }
     else if( $("#passport_no").val().match(/^\d{9}$/))
      {
           $("#passport_no").css("border-color", "green");
           $("#passport_no").css("background-color","");
           $("#passport_no").focus();
           ...
           return ispassport = true;
            ...
            $("#passport_no").css("border-color", "red");
            $("#passport_no").css("background-color","pink");
            $("#passport_no_error").html("Pass Port Is Valid .......!!")  ;
            $("#next-4").prop("disabled",false);
		return ispassport =false;
      }
});
...
$("#phone_number").keyup(function(){
      ...
      if($("#phone_number").val().match(/^\d{10}$/)  || $("#phone_number").val().match(/^\d{9}$/)){
            $("#phone_number").css("border-color","green");
            $("#phone_number").css("background-color","");
            $("#next-4").prop("disabled",false);
            $("#phone_number_error").html("") ;
...
$("#next-1").click(function(){
    if( $("#first_name").val() == "" || $("#last_name").val() == "" || $("#gender").val() == ""||  $("#dob").val() == "" )
    {
         
          $("#first_name").focus().addClass("input-error");     
          $("#last_name").focus().addClass("input-error");
          $("#gender").focus().addClass("input-error");      
...
if( $("#current_province").val() == "" || $("#current_district").val() == "" ||  $("#current_commune").val() == "" ||  $("#current_village").val() =="" )
    {
...
{
if(  $("#phone_number").val().length  == "" || $("#passport_no").val().length == "" ||   $("#nationality").val()== "0" || $("#nationality_id").val().length == ""  || $("#status").val() == "0" )
    {
          ...
          alert("You Are Update Error Please Chacking Again.........!!!!!! ");
          $("#next-4").prop("disabled",true); 
          $("#step_four").show();
          next_step=false;
    }
    ...
    {     
          ...
          $("#next-4").prop("disabled",false);
          $("#step_four").hide();
          alert("You Are Update Teacher SuccessFully.........!");
          var step_5 =$("#step_five").show();
          $(this).step_5.val(); 
          next_step=true;
    }
});
