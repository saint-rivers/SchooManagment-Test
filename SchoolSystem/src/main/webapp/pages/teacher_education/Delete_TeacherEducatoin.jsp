      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 id="title_student"> Delete Teacher Education Background</h2>
						...
						<div class="modal-dialog">
					    	<div class="modal-content">
					            ...
					            <div class="modal-body">
					    			<h5><i class="fa fa-info-circle text-danger"></i> Do you want to delete this <%=education_id %> ?</h5>
					                <h3 id="showTeachertName"></h3>
					            </div>
					            <div class="modal-footer">
					        		<button type="button" class="btn btn-info" id="No_btn" data-dismiss="modal">No</button>
					                <button type="button" name="yes" id="Yes_btn" class="btn btn-danger" data-dismiss="modal" value="<%=education_id %>">Yes</button>
					            </div>
					          </div>
					       </div>
					   </div>
