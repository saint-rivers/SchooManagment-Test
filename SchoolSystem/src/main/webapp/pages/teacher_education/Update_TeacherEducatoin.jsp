...
<body class="nav-md">
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 id="title_student"> Update Teacher Education Information</h2>
   ...
   <form role="form" class="registration-form" action="${pageContext.request.contextPath}/AddNewTeacherEducationServlet" Method="POST"  enctype="multipart/form-data" >
                      <% 
	                          	...
	                          	<div class="col-md-8 col-sm-9 col-xs-9">
	                            	 <small class="text-danger" id="gender_error"></small>
	                              	<select class="form-control" name="teacher_type" id="teacher_type">
                                	 	<option class="hidden" selected disabled >ជ្រើសរើស ប្រភេទគ្រូបង្រៀន</option>
