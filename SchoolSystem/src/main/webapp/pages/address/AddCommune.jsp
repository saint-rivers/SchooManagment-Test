                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <%
					...
					%>
                    <form action="${pageContext.request.contextPath}/AddNewCommune" class="form-horizontal form-label-left" method="Post">
                      ...
                      <div class="form-group row">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Commune Name</label>
