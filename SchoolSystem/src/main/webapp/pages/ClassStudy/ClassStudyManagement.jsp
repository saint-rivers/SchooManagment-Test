...
<html>
  <head>
    ...
    <style>
    	h4{font-family:Kh Ang Bokor New;}
    </style>
  </head>
<body class="nav-md">
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
        	<div class="col-md-12 col-sm-12">
        		<div class="x_panel">
                <div class="x_title">
                  <h2 class="p-2" style="font-family:Khmer OS Muol Light;"><i class="fa fa-graduation-cap fa-lg"></i> គ្រប់គ្រងថ្នាក់រៀន</h2>
	                	...
	                	<div class="row">
		                		...
		                		<div class="card card-primary card-outline-warning">
					              <div class="card-body box-profile">
					                <div class="text-center">
					                  	<a href="../../view/list/ClassStudy">  
					                   		<i class="fa fa-list-alt fa-4x text-info"></i> 	                    	
					                	</a>
					                </div>
					                <h4 class="profile-username text-center p-1">បញ្ជីថ្នាក់រៀន</h4>
					              </div>
			            		</div>
		                	</div>
		                	<div class="col-md-3 mt-3">
		                		<div class="card card-primary card-outline-warning">
					              <div class="card-body box-profile">
					                <div class="text-center">
					                  	<a href="../../view/StudentClass/ClassStudent">       	
					                   		<i class="fa fa-user-graduate fa-4x text-info"></i> 	                    	
					                	</a>
					                </div>
					                <h4 class="profile-username text-center p-1"> បញ្ចូលសិស្សតាមថ្នាក់</h4>
					              </div>
			            		</div>
		                	</div>
	                		...
	                		<div class="col-md-3 mt-3">
		                		<div class="card card-primary card-outline-warning">
					              <div class="card-body box-profile">
					                <div class="text-center">
					                  	<a href="../../view/add/TeacherClass">       	
					                   		<i class="fas fa-chalkboard-teacher fa-4x text-info"></i> 	                    	
					                	</a>
					                </div>
					                <h4 class="profile-username text-center p-1">បញ្ចូលគ្រូតាមថ្នាក់</h4>
					              </div>
			            		</div>
		                	</div>
