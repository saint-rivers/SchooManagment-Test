                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <%
                    	...
                    	SubjectCategoryBean scb = SubjectCategoryService.getASubjectCategory(catId);
                    %>
                    <form action="${pageContext.request.contextPath}/UpdateASubjectCategoryServlet" class="form-horizontal form-label-left" method="Post">

                      <div class="form-group row">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Subject Category ID</label>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <input type="text" name="category_name" value="<%=scb.getCategory_name() %>" class="form-control">
                        </div>
                      </div>
