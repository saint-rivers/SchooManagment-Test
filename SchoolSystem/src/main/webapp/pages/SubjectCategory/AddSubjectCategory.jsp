...
<%@ page import="db.services.AddByService" %>
         ...
         <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <%
						String catId = SubjectCategoryService.getNewId();
                  		 int add_id = AddByService.getNewId();
					%>
                   
                    <form action="${pageContext.request.contextPath}/AddSubjectCategoryServlet" class="form-horizontal form-label-left" method="Post">

                      <div class="form-group row">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">SchoolCategory ID</label>
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <input type="text" value="<%=catId %>" class="form-control" disabled>
                          <input type="hidden" name="category_id" value="<%=catId %>">
                            
                            <input type="hidden" id="add_by_id" name="add_by_id" value="<%=add_id %>">
                              <input type="hidden" id="time" name="time" >
                            <input type="hidden" id="input_date" name="input_date" >
                          <input type="hidden" id="add_bye" name="add_bye" value="<%=user_id %>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">SchoolCategory Name</label>
                        <div class="col-md-9 col-sm-9 col-xs-9">
                      ...
                      <div class="form-group row">
                        <div class="col-md-9 offset-md-3">
                          <a href="../../view/detail/ListSubjectCategory" class="btn btn-primary">Back</a>
