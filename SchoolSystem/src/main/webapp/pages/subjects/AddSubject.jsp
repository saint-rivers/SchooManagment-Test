...
<body class="nav-md">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <%
					...
					%>
                    <form action="${pageContext.request.contextPath}/AddNewSubject" class="form-horizontal form-label-left" method="Post">

                      <div class="form-group row">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Subject ID</label>
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <input type="text" value="<%=subID %>" class="form-control"​​​ disabled>
                      ...
                      <div class="form-group row">
						...
						<div class="col-md-9 col-sm-9 ">
							<select class="form-control" name="category_id">
                                     <%
                                      ArrayList<SubjectCategoryBean> ListSCB = SubjectService.p_listAllCategory();
                      ...
                      <div class="form-group row">
                        <div class="col-md-9 offset-md-3">
                          ...
                          <button type="submit" class="btn btn-success" id="add_subjects">Submit</button>
                        </div>
                      </div>
    ...
    <script src="../../js/custom_js/teacher/Current_Day_and_Validation_subject.js"></script>
