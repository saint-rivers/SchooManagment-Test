					                    		...
					                    		<table id="datatable-responsive" class="table table table-hover table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;">
								                      <thead>
								                        <tr  role="row" class="table-success text-center">
								                        	<th class="sorting" style="width: 30px;">អត្តលេខ</th>
								                        	<th class="sorting" style="width: 68px;">ឈ្មោះ</th>
								                        	<th class="sorting" style="width: 30px;">ភេទ</th>								                        		
								                        	<th class="sorting_asc" style="width: 50px;">រូបថត</th>	
								                        	<th class="sorting" style="width: 130px;">ការកំណត់</th>	
								                        </tr>
								                      </thead>
								                      <tbody>
								                      	<%
								                      		...
								                      		for(StudentBean sb : ListSB){
								                      			out.print("<tr role='row' class='odd'>");
								                      				...
								                      				out.print("<td class='text-center'><img style='border: 2px solid blue;' src='../../images/students/" + sb.getPhoto_name() + "' width='70px' height='70px'></td>");
								                      				out.print("<td class='text-center'>");
								                      					out.print("<a href='../../view/profile/StudentProfile' class='btn btn-secondary btn-sm' data-toggle='tooltip' data-placement='top' title='profile'><i class='fa fa-eye'></i></a>");
