                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <%
                    	...
                    	RoomBean rb =RoomService.getAClassroom(roomId);
                    %>
                    <form action="${pageContext.request.contextPath}/UpdateAClassroom" class="form-horizontal form-label-left" method="Post">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <input type="text" name="room_name" value="<%=rb.getRoom() %>" class="form-control">
                        </div>
                      </div>
